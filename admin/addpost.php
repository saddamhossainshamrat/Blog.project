        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                ...
                if($_SERVER['REQUEST_METHOD']== 'POST'){
                    ...
                    $uaerid = mysqli_real_escape_string($db->link, $_POST['userid']);
                    ...
                    if ($title == "" || $cat == "" || $body == "" || $tags == "" || $des == ""  || $author == "" || $file_name == ""){
                echo "<span class='error'>Field must not be empty !</span>";
                        ...
                        $query = "INSERT INTO tbl_post( cat, title, body, image, author, tags, des, userid) VALUES ('$cat','$title', '$body', '$uploaded_image','$author','$tags', '$des','$userid')";
